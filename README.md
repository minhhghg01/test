...
- ![](res/sprites/brickPlus.png) & ![](res/sprites/brickPlus1.png) *BrickPlus* là Brick dạng đặc biệt cần phải nổ bom 2 lần để bị phá hủy.


- ![](res/sprites/portal.png) *Portal* là đối tượng được giấu phía sau một đối tượng Brick. Khi Brick đó bị phá hủy, Portal sẽ hiện ra và nếu tất cả Enemy đã bị tiêu diệt thì người chơi có thể qua Level khác bằng cách di chuyển vào vị trí của Portal.

- ![](res/sprites/teleport.png) *Teleport* là đối tượng đặc biệt, luôn theo cặp 2 cổng. Đặc tính là nếu Bomber đi qua 1 trong 2 cổng thì Bomber sẽ được chuyển đến vị trí cổng còn lại.
...
- Ngoài ra còn nhiều Enemy khác với tốc độ và cách di chuyển khác.
- ![](res/sprites/angry_left_1.png) & ![](res/sprites/smile_left_1.png) *Angry & Smile* có tốc độ di chuyển thay đổi, lúc nhanh, lúc chậm và di chuyển "thông minh" hơn so với Balloom (biết đuổi theo Bomber), có 2 trạng thái và có khả năng đặc biệt.
